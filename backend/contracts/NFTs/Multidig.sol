...
contract Multidig is ERC721Enumerable, ERC721URIStorage {
    using Counters for Counters.Counter;
    Counters.Counter private _nextTokenId;
    address _marketplace;
    uint128 constant MAX_TOKENS_TO_MINT = 5; // 5000


    constructor(address marketplaceAddress) ERC721("Multidig", "MUD") {
